import{r as l,j as e,H as d,L as s}from"./app-0H0V-A7H.js";import{B as m}from"./button-CC7iN1gr.js";import{W as h,m as x}from"./WebLayout-BlfMKSXg.js";import{A as g}from"./arrow-right-CbQqZY3u.js";/* empty css            */import"./createLucideIcon-BkhVfZes.js";import"./use-mobile-C7jnDNXA.js";import"./index-BEKqreAs.js";import"./index-DxTTAI6e.js";import"./index-BOOQIOdh.js";import"./floating-ui.react-dom-BbxgJ28M.js";import"./chevron-down-CMFDLLVw.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
