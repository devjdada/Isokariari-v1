import{r as l,j as e,H as d,L as s}from"./app-ikZaHAeh.js";import{B as m}from"./button-CuPzQEo1.js";import{W as h,m as x}from"./WebLayout-BbKxM-u7.js";import{A as g}from"./arrow-right-BKAh5FVm.js";/* empty css            */import"./createLucideIcon-Cj1hmbng.js";import"./use-mobile-B9xFdgbH.js";import"./index-C6nWi0Bi.js";import"./index-DUzO91nk.js";import"./index-DAnG4KlX.js";import"./floating-ui.react-dom-CbTUF4yy.js";import"./chevron-down-BsAxhN19.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
