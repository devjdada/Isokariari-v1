import{r as l,j as e,H as d,L as s}from"./app-B5exnm2P.js";import{B as m}from"./button-Cv7NUm1V.js";import{W as h,m as x}from"./WebLayout-DxvXEVzd.js";import{A as g}from"./arrow-right-dFwSEe6v.js";/* empty css            */import"./createLucideIcon-IgKErlXk.js";import"./use-mobile-XfPOUrGK.js";import"./index-CJaa5Q4z.js";import"./index-BntwFaVz.js";import"./index-Cmm98eox.js";import"./floating-ui.react-dom-RClVUsdt.js";import"./chevron-down-DNXnff_g.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
