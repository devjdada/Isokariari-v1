...
type PopoverContextValue = ReturnType<typeof usePopover> & {
    ...
    updatePosition: (side: 'top' | 'right' | 'bottom' | 'left', align: 'start' | 'center' | 'end', sideOffset?: number, alignOffset?: number) => void;
};
...
function usePopover({
    ...
    const updatePosition = React.useCallback(
        (newSide: 'top' | 'right' | 'bottom' | 'left', newAlign: 'start' | 'center' | 'end', newSideOffset?: number, newAlignOffset?: number) => {
