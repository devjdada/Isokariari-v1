import{r as l,j as e,H as d,L as s}from"./app-BDJzKkFP.js";import{B as m}from"./button-4rrgNgaj.js";import{W as h,m as x}from"./WebLayout-Ccx2RZgw.js";import{A as g}from"./arrow-right-BtTTcYuI.js";/* empty css            */import"./createLucideIcon-CgubSX4y.js";import"./use-mobile-CurvR31g.js";import"./index-CfDnA0ZY.js";import"./index-D9e2VEw3.js";import"./index-BjgKvWmE.js";import"./floating-ui.react-dom-DbIr9Nq5.js";import"./chevron-down-BUjsPvhw.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
