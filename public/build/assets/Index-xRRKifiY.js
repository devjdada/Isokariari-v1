import{r as l,j as e,H as d,L as s}from"./app-BZowfdJs.js";import{B as m}from"./button-BnAbB3ES.js";import{W as h,m as x}from"./WebLayout-Bncg6Uvm.js";import{A as g}from"./arrow-right-Dgmx3Wto.js";/* empty css            */import"./createLucideIcon-CZFPyzm1.js";import"./use-mobile-i7u9yAo5.js";import"./index-BP2IzyIL.js";import"./index-lrPwCM4h.js";import"./index-CGu4Bvsi.js";import"./floating-ui.react-dom-CLpDAt2v.js";import"./chevron-down-Cz-tWhut.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
