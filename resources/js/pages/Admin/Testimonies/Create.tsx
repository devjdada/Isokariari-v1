...
export default function TestimonyCreate({ auth }: PageProps) {
    const { data, setData, post, processing, errors, reset } = useForm<TestimonyFormData>({
        name: '',
        position: '',
        company: '',
        content: '',
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="text-xl leading-tight font-semibold text-gray-800">Create Testimony</h2>}>
