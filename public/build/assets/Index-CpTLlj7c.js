import{r as l,j as e,H as d,L as s}from"./app-B2QCHc5d.js";import{B as m}from"./button-DxsLSi_n.js";import{W as h,m as x}from"./WebLayout-1bSI9WiM.js";import{A as g}from"./arrow-right-DIrDIWCS.js";/* empty css            */import"./createLucideIcon-CYahJQZU.js";import"./use-mobile-8dOiAHf3.js";import"./index-Bd_l7Eb8.js";import"./index-wTBGWor2.js";import"./index-CAcRUttx.js";import"./floating-ui.react-dom-B2BF2PCz.js";import"./chevron-down-DnDW9sns.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
