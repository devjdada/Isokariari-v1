import{r as l,j as e,H as d,L as s}from"./app-Tym7WeGa.js";import{B as m}from"./button-p6axQEC_.js";import{W as h,m as x}from"./WebLayout-CJHfBHdv.js";import{A as g}from"./arrow-right-M2Xj5rJK.js";/* empty css            */import"./createLucideIcon-Ctz4MQX9.js";import"./use-mobile-7AW_vrix.js";import"./index-DVZiuZ48.js";import"./index-D8lDxqL2.js";import"./index-BcdD4NpO.js";import"./floating-ui.react-dom-II77FIsv.js";import"./chevron-down-DGS6Cx1m.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
