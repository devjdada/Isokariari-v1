import{r as l,j as e,H as d,L as s}from"./app-_SHXlIMi.js";import{B as m}from"./button-D90eb9uh.js";import{W as h,m as x}from"./WebLayout-CUsh-YFM.js";import{A as g}from"./arrow-right-Cn5DdT91.js";/* empty css            */import"./createLucideIcon-Cxr0x7Gx.js";import"./use-mobile-BmM3Cx0C.js";import"./index-DxYDQp86.js";import"./index-CE-JyWoC.js";import"./index-CNvgb3hZ.js";import"./floating-ui.react-dom-DzZXuo7M.js";import"./chevron-down-Du6pogeH.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
