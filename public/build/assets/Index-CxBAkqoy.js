import{r as l,j as e,H as d,L as s}from"./app-Ci7JPyDS.js";import{B as m}from"./button-D7MokS7-.js";import{W as h,m as x}from"./WebLayout-BXfycnWy.js";import{A as g}from"./arrow-right-CdXUKqtb.js";/* empty css            */import"./createLucideIcon-Bbeo22x8.js";import"./use-mobile-wLyCuZN1.js";import"./index-DWTpDU_y.js";import"./index-CrjImHXw.js";import"./index-Db2zC06E.js";import"./floating-ui.react-dom-BoWHKX32.js";import"./chevron-down-BHS8eUuW.js";function S({services:i}){const[c,a]=l.useState(""),n="/images/logo.png";return l.useEffect(()=>{let t;if(Array.isArray(i)&&i.length>0){const r=i.map(o=>o?.image?.trim()).filter(o=>o);r.length>1?(a(r[Math.floor(Math.random()*r.length)]),t=setInterval(()=>{const o=r[Math.floor(Math.random()*r.length)];a(o)},3e3)):a(r[0]||n)}else a(n);return()=>{t&&clearInterval(t)}},[i]),e.jsxs(h,{children:[e.jsx(d,{title:"Our Services"}),e.jsxs("div",{children:[e.jsx("style",{children:`
        .team-hero-bg {
